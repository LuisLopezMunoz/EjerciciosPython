...
def obtener_sex():
    sexo = input("Por favor indicame tu sexo. ")
    return sexo
...
def mostrar_perfil(nombre, sexo, pais, edad, estatura_m, estatura_cm, num_amigos):
    print("--------------------------------------------------")
    print("Nombre   :", nombre)
    print("Sexo     :", sexo)
    print("País     :", pais)
...
mostrar_perfil(nombre, sexo, pais, edad, estatura_m, estatura_cm, num_amigos)
