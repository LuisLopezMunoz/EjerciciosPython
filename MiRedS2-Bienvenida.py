...
lenguaje = input("Hablanos un poco más de ti ¿Cuál es tu lenguaje de programación favorito? ")
print()

IDE = input("¿Cuál es tu IDE favorito? ")
print()

goal = input("¿Cuál es tu objetivo en este curso? ")
print()
print("--------------------------------------------------")
print("Podríamos decir entonces que trabajas en", IDE, "escribiendo en", lenguaje, "para conseguir", goal)
print("--------------------------------------------------")
