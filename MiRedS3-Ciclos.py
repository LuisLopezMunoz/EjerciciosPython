...
modificar = input("¿Deseas agregar información adicional? S/N: ")
dato=""
info=""
if modificar=="S" or modificar=="s" or modificar=="Sí":
    dato = input("¿que dato adicional deseas agregar?: ")
    info = input(print("Cuál o como es tu", dato, ": "))
